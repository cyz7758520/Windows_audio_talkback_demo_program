...
__DATASTRUCT_DLLAPI__ int VLnkLstPutHead( VLnkLst * VLnkLstPt, const void * NewHeadElmDataPt, size_t NewHeadElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int VLnkLstPutTail( VLnkLst * VLnkLstPt, const void * NewTailElmDataPt, size_t NewTailElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int VLnkLstPutPrevByIdx( VLnkLst * VLnkLstPt, size_t SpecElmIdx, const void * NewPrevElmDataPt, size_t NewPrevElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int VLnkLstPutPrevByNum( VLnkLst * VLnkLstPt, size_t SpecElmNum, const void * NewPrevElmDataPt, size_t NewPrevElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int VLnkLstPutNextByIdx( VLnkLst * VLnkLstPt, size_t SpecElmIdx, const void * NewNextElmDataPt, size_t NewNextElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int VLnkLstPutNextByNum( VLnkLst * VLnkLstPt, size_t SpecElmNum, const void * NewNextElmDataPt, size_t NewNextElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
...
__DATASTRUCT_DLLAPI__ int VLnkLstDelHead( VLnkLst * VLnkLstPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int VLnkLstDelTail( VLnkLst * VLnkLstPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int VLnkLstDelPrevByIdx( VLnkLst * VLnkLstPt, size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int VLnkLstDelNextByIdx( VLnkLst * VLnkLstPt, size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int VLnkLstDelByIdx( VLnkLst * VLnkLstPt, size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int VLnkLstDelByNum( VLnkLst * VLnkLstPt, size_t SpecElmNum, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
...
public:
	...
	int PutHead( const void * NewHeadElmDataPt, size_t NewHeadElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstPutHead( m_VLnkLstPt, NewHeadElmDataPt, NewHeadElmDataLenByt, IsAutoLock, ErrInfoVstrPt ); }
	int PutTail( const void * NewTailElmDataPt, size_t NewTailElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstPutTail( m_VLnkLstPt, NewTailElmDataPt, NewTailElmDataLenByt, IsAutoLock, ErrInfoVstrPt ); }
	int PutPrevByIdx( size_t SpecElmIdx, const void * NewPrevElmDataPt, size_t NewPrevElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstPutPrevByIdx( m_VLnkLstPt, SpecElmIdx, NewPrevElmDataPt, NewPrevElmDataLenByt, IsAutoLock, ErrInfoVstrPt ); }
	int PutPrevByNum( size_t SpecElmNum, const void * NewPrevElmDataPt, size_t NewPrevElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstPutPrevByNum( m_VLnkLstPt, SpecElmNum, NewPrevElmDataPt, NewPrevElmDataLenByt, IsAutoLock, ErrInfoVstrPt ); }
	int PutNextByIdx( size_t SpecElmIdx, const void * NewNextElmDataPt, size_t NewNextElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstPutNextByIdx( m_VLnkLstPt, SpecElmIdx, NewNextElmDataPt, NewNextElmDataLenByt, IsAutoLock, ErrInfoVstrPt ); }
	int PutNextByNum( size_t SpecElmNum, const void * NewNextElmDataPt, size_t NewNextElmDataLenByt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstPutNextByNum( m_VLnkLstPt, SpecElmNum, NewNextElmDataPt, NewNextElmDataLenByt, IsAutoLock, ErrInfoVstrPt ); }
	...
	int DelHead( int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstDelHead( m_VLnkLstPt, IsAutoLock, ErrInfoVstrPt ); }
	int DelTail( int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstDelTail( m_VLnkLstPt, IsAutoLock, ErrInfoVstrPt ); }
	int DelPrevByIdx( size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstDelPrevByIdx( m_VLnkLstPt, SpecElmIdx, IsAutoLock, ErrInfoVstrPt ); }
	int DelNextByIdx( size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstDelNextByIdx( m_VLnkLstPt, SpecElmIdx, IsAutoLock, ErrInfoVstrPt ); }
	int DelByIdx( size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstDelByIdx( m_VLnkLstPt, SpecElmIdx, IsAutoLock, ErrInfoVstrPt ); }
	int DelByNum( size_t SpecElmNum, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return VLnkLstDelByNum( m_VLnkLstPt, SpecElmNum, IsAutoLock, ErrInfoVstrPt ); }
