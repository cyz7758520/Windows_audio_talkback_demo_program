...
__DATASTRUCT_DLLAPI__ int CLnkLstPutHead( CLnkLst * CLnkLstPt, const void * NewHeadElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int CLnkLstPutTail( CLnkLst * CLnkLstPt, const void * NewTailElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int CLnkLstPutPrevByIdx( CLnkLst * CLnkLstPt, size_t SpecElmIdx, const void * NewPrevElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int CLnkLstPutPrevByNum( CLnkLst * CLnkLstPt, size_t SpecElmNum, const void * NewPrevElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int CLnkLstPutNextByIdx( CLnkLst * CLnkLstPt, size_t SpecElmIdx, const void * NewNextElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int CLnkLstPutNextByNum( CLnkLst * CLnkLstPt, size_t SpecElmNum, const void * NewNextElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
...
__DATASTRUCT_DLLAPI__ int CLnkLstDelHead( CLnkLst * CLnkLstPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int CLnkLstDelTail( CLnkLst * CLnkLstPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int CLnkLstDelPrevByIdx( CLnkLst * CLnkLstPt, size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int CLnkLstDelNextByIdx( CLnkLst * CLnkLstPt, size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int CLnkLstDelByIdx( CLnkLst * CLnkLstPt, size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
__DATASTRUCT_DLLAPI__ int CLnkLstDelByNum( CLnkLst * CLnkLstPt, size_t SpecElmNum, int32_t IsAutoLock, Vstr * ErrInfoVstrPt );
...
public:
	...
	int PutHead( const void * NewHeadElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstPutHead( m_CLnkLstPt, NewHeadElmDataPt, IsAutoLock, ErrInfoVstrPt ); }
	int PutTail( const void * NewTailElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstPutTail( m_CLnkLstPt, NewTailElmDataPt, IsAutoLock, ErrInfoVstrPt ); }
	int PutPrevByIdx( size_t SpecElmIdx, const void * NewPrevElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstPutPrevByIdx( m_CLnkLstPt, SpecElmIdx, NewPrevElmDataPt, IsAutoLock, ErrInfoVstrPt ); }
	int PutPrevByNum( size_t SpecElmNum, const void * NewPrevElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstPutPrevByNum( m_CLnkLstPt, SpecElmNum, NewPrevElmDataPt, IsAutoLock, ErrInfoVstrPt ); }
	int PutNextByIdx( size_t SpecElmIdx, const void * NewNextElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstPutNextByIdx( m_CLnkLstPt, SpecElmIdx, NewNextElmDataPt, IsAutoLock, ErrInfoVstrPt ); }
	int PutNextByNum( size_t SpecElmNum, const void * NewNextElmDataPt, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstPutNextByNum( m_CLnkLstPt, SpecElmNum, NewNextElmDataPt, IsAutoLock, ErrInfoVstrPt ); }
	...
	int DelHead( int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstDelHead( m_CLnkLstPt, IsAutoLock, ErrInfoVstrPt ); }
	int DelTail( int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstDelTail( m_CLnkLstPt, IsAutoLock, ErrInfoVstrPt ); }
	int DelPrevByIdx( size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstDelPrevByIdx( m_CLnkLstPt, SpecElmIdx, IsAutoLock, ErrInfoVstrPt ); }
	int DelNextByIdx( size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstDelNextByIdx( m_CLnkLstPt, SpecElmIdx, IsAutoLock, ErrInfoVstrPt ); }
	int DelByIdx( size_t SpecElmIdx, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstDelByIdx( m_CLnkLstPt, SpecElmIdx, IsAutoLock, ErrInfoVstrPt ); }
	int DelByNum( size_t SpecElmNum, int32_t IsAutoLock, Vstr * ErrInfoVstrPt ) { return CLnkLstDelByNum( m_CLnkLstPt, SpecElmNum, IsAutoLock, ErrInfoVstrPt ); }
