...
DWORD WINAPI AudioInputThreadRun( MediaProcThread * MediaProcThreadPt )
{
	...
	while( GetMessage( &MediaProcThreadPt->m_AudioInput.m_Msg, NULL, 0, 0 ) != 0 )
	{
		if( MediaProcThreadPt->m_AudioInput.m_Msg.message == WIM_DATA ) //如果是音频输入缓冲区块读取完毕消息。
		{
			...
			MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.GetTotal( &MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLstElmTotal, 1, NULL ); //获取音频输入空闲帧链表的元素总数。
			if( MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLstElmTotal > 0 ) //如果音频输入空闲帧链表中有音频输入空闲帧。
			{
				//从音频输入空闲帧链表中取出第一个音频输入空闲帧。
				{
					MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.Lock( NULL ); //音频输入空闲帧链表的互斥锁加锁。
					MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.GetHead( NULL, &MediaProcThreadPt->m_AudioInput.m_AudioInputFramePt, NULL, 0, NULL );
					MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.DelHead( 0, NULL );
					MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.Unlock( NULL ); //音频输入空闲帧链表的互斥锁解锁。
				}
			...
			//追加本次音频输入帧到音频输入帧链表。
			if( MediaProcThreadPt->m_AudioInput.m_AudioInputFramePt != NULL ) //如果获取了一个音频输入空闲帧。
			{
				...
				MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.PutTail( &MediaProcThreadPt->m_AudioInput.m_AudioInputFramePt, 1, NULL );
			...
			if( MediaProcThreadPt->m_IsPrintLog != 0 )
			{
				...
				LOGFI( "音频输入线程：本次音频输入帧读取完毕，耗时 %" PRIu64 " 毫秒。", MediaProcThreadPt->m_AudioInput.m_NowTimeMsec - MediaProcThreadPt->m_AudioInput.m_LastTimeMsec );
...
DWORD WINAPI AudioOutputThreadRun( MediaProcThread * MediaProcThreadPt )
{
	...
	while( GetMessage( &MediaProcThreadPt->m_AudioOutput.m_Msg, NULL, 0, 0 ) != 0 )
	{
		if( MediaProcThreadPt->m_AudioOutput.m_Msg.message == WOM_DONE ) //如果是音频输出缓冲区块写入完毕消息。
		{
			...
			//获取一个音频输出空闲帧。
			MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.GetTotal( &MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLstElmTotal, 1, NULL );
			if( MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLstElmTotal > 0 ) //如果音频输出空闲帧链表中有音频输出空闲帧。
			{
				//从音频输出空闲帧链表中取出第一个音频输出空闲帧。
				{
					MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.Lock( NULL ); //音频输出空闲帧链表的互斥锁加锁。
					MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.GetHead( NULL, &MediaProcThreadPt->m_AudioOutput.m_AudioOutputFramePt, NULL, 0, NULL );
					MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.DelHead( 0, NULL );
					MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.Unlock( NULL ); //音频输出空闲帧链表的互斥锁解锁。
				}
			...
			if( MediaProcThreadPt->m_AudioOutput.m_AudioOutputFramePt != NULL )
			{
				...
				MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.PutTail( &MediaProcThreadPt->m_AudioOutput.m_AudioOutputFramePt, 1, NULL );
			...
			if( MediaProcThreadPt->m_IsPrintLog != 0 )
			{
				...
				LOGFI( "音频输出线程：本次音频输出帧写入完毕，耗时 %" PRIu64 " 毫秒。", MediaProcThreadPt->m_AudioOutput.m_NowTimeMsec - MediaProcThreadPt->m_AudioOutput.m_LastTimeMsec );
...
public:
	...
	STDMETHODIMP BufferCB( double dblSampleTime, BYTE * pBuffer, long lBufferSize )
	{
		...
		//获取一个视频输入空闲帧元素。
		m_MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.GetTotal( &m_MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLstElmTotal, 1, NULL );
        if( m_MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLstElmTotal > 0 ) //如果视频输入空闲帧链表中有视频输入空闲帧元素。
        {
            //从视频输入空闲帧链表中取出第一个视频输入空闲帧元素。
            {
				m_MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.Lock( NULL ); //视频输入空闲帧链表的互斥锁加锁。
                m_MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.GetHead( NULL, &m_MediaProcThreadPt->m_VideoInput.m_VideoInputFrameElmPt, NULL, 0, NULL );
				m_MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.DelHead( 0, NULL );
				m_MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.Unlock( NULL ); //视频输入空闲帧链表的互斥锁解锁。
            }
		...
		//追加本次视频输入帧到视频输入帧链表。
		m_MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLst.PutTail( &m_MediaProcThreadPt->m_VideoInput.m_VideoInputFrameElmPt, 1, NULL );
		...
		{
			m_MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.PutTail( &m_MediaProcThreadPt->m_VideoInput.m_VideoInputFrameElmPt, 1, NULL );
			m_MediaProcThreadPt->m_VideoInput.m_VideoInputFrameElmPt = NULL;
		}
		return 0;
	}
...
DWORD WINAPI MediaProcThreadRun( MediaProcThread * MediaProcThreadPt )
{
	...
	if( MediaProcThreadPt->m_AudioInput.m_IsUseAudioInput != 0 )
	{
			...
			case 3: //如果使用WebRtc浮点版声学回音消除器。
			{
				if( ( MediaProcThreadPt->m_AudioOutput.m_IsUseAudioOutput != 0 ) && ( MediaProcThreadPt->m_AudioOutput.m_SamplingRate == MediaProcThreadPt->m_AudioInput.m_SamplingRate ) && ( MediaProcThreadPt->m_AudioOutput.m_FrameLen == MediaProcThreadPt->m_AudioInput.m_FrameLen ) ) //如果要使用音频输出，且音频输出的采样频率和帧的数据长度与音频输入一致。
                {
					...
					if( MediaProcThreadPt->m_AudioInput.m_WebRtcAecPt == NULL )
					{
						...
						{
							if( MediaProcThreadPt->m_IsPrintLog != 0 ) LOGFE( "媒体处理线程：创建并初始化WebRtc浮点版声学回音消除器失败。原因：%s", MediaProcThreadPt->m_ErrInfoVarStrPt->m_StrPt );
							goto out;
						}
					}
                }
		...
		switch( MediaProcThreadPt->m_AudioInput.m_UseWhatNs )
		{
			...
			{
				if( WebRtcNsxInit( &MediaProcThreadPt->m_AudioInput.m_WebRtcNsxPt, MediaProcThreadPt->m_AudioInput.m_SamplingRate, MediaProcThreadPt->m_AudioInput.m_FrameLen, MediaProcThreadPt->m_AudioInput.m_WebRtcNsxPolicyMode, MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
				{
					if( MediaProcThreadPt->m_IsPrintLog != 0 ) LOGFI( "媒体处理线程：创建并初始化WebRtc定点版噪音抑制器成功。" );
				}
				else
				{
					if( MediaProcThreadPt->m_IsPrintLog != 0 ) LOGFE( "媒体处理线程：创建并初始化WebRtc定点版噪音抑制器失败。原因：%s", MediaProcThreadPt->m_ErrInfoVarStrPt->m_StrPt );
					goto out;
				}
				break;
			}
			...
			{
				if( WebRtcNsInit( &MediaProcThreadPt->m_AudioInput.m_WebRtcNsPt, MediaProcThreadPt->m_AudioInput.m_SamplingRate, MediaProcThreadPt->m_AudioInput.m_FrameLen, MediaProcThreadPt->m_AudioInput.m_WebRtcNsPolicyMode, MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
				{
					if( MediaProcThreadPt->m_IsPrintLog != 0 ) LOGFI( "媒体处理线程：创建并初始化WebRtc浮点版噪音抑制器成功。" );
				}
				else
				{
					if( MediaProcThreadPt->m_IsPrintLog != 0 ) LOGFE( "媒体处理线程：创建并初始化WebRtc浮点版噪音抑制器失败。原因：%s", MediaProcThreadPt->m_ErrInfoVarStrPt->m_StrPt );
					goto out;
				}
				break;
			}
			...
			{
				if( RNNoiseInit( &MediaProcThreadPt->m_AudioInput.m_RNNoisePt, MediaProcThreadPt->m_AudioInput.m_SamplingRate, MediaProcThreadPt->m_AudioInput.m_FrameLen, MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
				{
					if( MediaProcThreadPt->m_IsPrintLog != 0 ) LOGFI( "媒体处理线程：创建并初始化RNNoise噪音抑制器成功。" );
				}
				else
				{
					if( MediaProcThreadPt->m_IsPrintLog != 0 ) LOGFE( "媒体处理线程：创建并初始化RNNoise噪音抑制器失败。原因：%s", MediaProcThreadPt->m_ErrInfoVarStrPt->m_StrPt );
					goto out;
				}
				break;
			}
		...
		//创建并初始化音频输入帧链表、音频输入空闲帧链表。
		{
			...
			if( MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.Init( sizeof( int16_t * ), LNKLST_BUF_AUTO_ADJ_METH_NONE, 0, MediaProcThreadPt->m_AudioInput.m_AudioInputFrameElmTotal, MediaProcThreadPt->m_AudioInput.m_AudioInputFrameElmTotal, MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
			{
			...
			if( MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.Init( sizeof( int16_t * ), LNKLST_BUF_AUTO_ADJ_METH_NONE, 0, MediaProcThreadPt->m_AudioInput.m_AudioInputFrameElmTotal, MediaProcThreadPt->m_AudioInput.m_AudioInputFrameElmTotal, MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
			{
				if( MediaProcThreadPt->m_IsPrintLog != 0 ) LOGFI( "媒体处理线程：创建并初始化音频输入帧链表成功。" );
			}
			else
			...
			for( p_TmpInt322 = 0; p_TmpInt322 < MediaProcThreadPt->m_AudioInput.m_AudioInputFrameElmTotal; p_TmpInt322++ )
			{
				...
				if( MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.PutTail( &MediaProcThreadPt->m_PcmAudioInputFramePt, 0, MediaProcThreadPt->m_ErrInfoVarStrPt ) != 0 )
				{
	...
	if( MediaProcThreadPt->m_AudioOutput.m_IsUseAudioOutput != 0 )
	{
		...
		//创建并初始化音频输出帧链表、音频输出空闲帧链表。
		{
			...
			if( MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.Init( sizeof( int16_t * ), LNKLST_BUF_AUTO_ADJ_METH_NONE, 0, MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameElmTotal, MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameElmTotal, MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
			{
			...
			if( MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.Init( sizeof( int16_t * ), LNKLST_BUF_AUTO_ADJ_METH_NONE, 0, MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameElmTotal, MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameElmTotal, MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
			{
			...
			for( p_TmpInt322 = 0; p_TmpInt322 < MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameElmTotal; p_TmpInt322++ )
			{
				...
				if( MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.PutTail( &MediaProcThreadPt->m_PcmAudioOutputFramePt, 0, MediaProcThreadPt->m_ErrInfoVarStrPt ) != 0 )
				{
	...
	if( MediaProcThreadPt->m_VideoInput.m_IsUseVideoInput != 0 )
	{
		...
		//创建并初始化视频输入帧链表、视频输入空闲帧链表。
		{
			...
			if( MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLst.Init( sizeof( MediaProcThread::VideoInput::VideoInputFrameElm * ), LNKLST_BUF_AUTO_ADJ_METH_NONE, 0, MediaProcThreadPt->m_VideoInput.m_VideoInputFrameElmTotal, MediaProcThreadPt->m_VideoInput.m_VideoInputFrameElmTotal, MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
			{
			...
			if( MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.Init( sizeof( MediaProcThread::VideoInput::VideoInputFrameElm * ), LNKLST_BUF_AUTO_ADJ_METH_NONE, 0, MediaProcThreadPt->m_VideoInput.m_VideoInputFrameElmTotal, MediaProcThreadPt->m_VideoInput.m_VideoInputFrameElmTotal, MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
			{
			...
			for( p_TmpInt322 = 0; p_TmpInt322 < MediaProcThreadPt->m_VideoInput.m_VideoInputFrameElmTotal; p_TmpInt322++ )
			{
				...
				if( MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.PutTail( &MediaProcThreadPt->m_VideoInputFramePt, 0, MediaProcThreadPt->m_ErrInfoVarStrPt ) != 0 )
				{
					free( MediaProcThreadPt->m_VideoInputFramePt->m_YU12VideoInputFramePt );
					MediaProcThreadPt->m_VideoInputFramePt->m_YU12VideoInputFramePt = NULL;
					if( MediaProcThreadPt->m_VideoInputFramePt->m_EncoderVideoInputFramePt != NULL )
	...
	while( true )
	{
		...
		//取出音频输入帧和音频输出帧。
		if( MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.m_ConstLenLnkLstPt != NULL ) MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.GetTotal( &p_TmpSz1, 1, NULL ); //获取音频输入帧链表的元素总数。
		else p_TmpSz1 = 0;
		if( MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.m_ConstLenLnkLstPt != NULL ) MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.GetTotal( &p_TmpSz2, 1, NULL ); //获取音频输出帧链表的元素总数。
		else p_TmpSz2 = 0;
		if( ( p_TmpSz1 > 0 ) && ( p_TmpSz2 > 0 ) ) //如果音频输入帧链表和音频输出帧链表中都有帧了，才开始取出。
		{
			//从音频输入帧链表中取出第一个音频输入帧。
			{
				MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.Lock( NULL ); //音频输入帧链表的互斥锁加锁。
				MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.GetHead( NULL, &MediaProcThreadPt->m_PcmAudioInputFramePt, NULL, 0, NULL );
				MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.DelHead( 0, NULL );
				MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.Unlock( NULL ); //音频输入帧链表的互斥锁解锁。
			}
			if( MediaProcThreadPt->m_IsPrintLog != 0 ) LOGFI( "媒体处理线程：从音频输入帧链表中取出第一个音频输入帧，音频输入帧链表元素个数：%" PRIi32 "。", p_TmpSz1 );

			//从音频输出帧链表中取出第一个音频输出帧。
			{
				MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.Lock( NULL ); //音频输出帧链表的互斥锁加锁。
				MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.GetHead( NULL, &MediaProcThreadPt->m_PcmAudioOutputFramePt, NULL, 0, NULL );
				MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.DelHead( 0, NULL );
				MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.Unlock( NULL ); //音频输出帧链表的互斥锁解锁。
			}
		...
		else if( ( p_TmpSz1 > 0 ) && ( MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.m_ConstLenLnkLstPt == NULL ) ) //如果音频输入帧链表有帧了，且不使用音频输出帧链表，就开始取出。
		{
			//从音频输入帧链表中取出第一个音频输入帧。
			{
				MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.Lock( NULL ); //音频输入帧链表的互斥锁加锁。
		...
		else if( ( p_TmpSz2 > 0 ) && ( MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.m_ConstLenLnkLstPt == NULL ) ) //如果音频输出帧链表有帧了，且不使用音频输入帧链表，就开始取出。
		{
			//从音频输出帧链表中取出第一个音频输出帧。
			{
				MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.Lock( NULL ); //音频输出帧链表的互斥锁加锁。
        ...
        //处理视频输入帧。
		if( MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLst.m_ConstLenLnkLstPt != NULL )
		{
			MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLst.GetTotal( &p_TmpSz1, 1, NULL ); //获取视频输入帧链表的元素总数。
		}
		else p_TmpSz1 = 0;
        if( ( p_TmpSz1 > 0 ) && //如果视频输入帧链表中有帧了。
            ( ( MediaProcThreadPt->m_PcmAudioInputFramePt != NULL ) || ( MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.m_ConstLenLnkLstPt == NULL ) ) ) //且已经处理了音频输入帧或不使用音频输入帧链表。
        {
            //从视频输入帧链表中取出第一个视频输入帧。
            {
				MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLst.Lock( NULL ); //视频输入帧链表的互斥锁加锁。
				MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLst.GetHead( NULL, &MediaProcThreadPt->m_VideoInputFramePt, NULL, 0, NULL );
				MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLst.DelHead( 0, NULL );
				MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLst.Unlock( NULL ); //视频输入帧链表的互斥锁解锁。
            }
		...
		{
			MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.PutTail( &MediaProcThreadPt->m_PcmAudioInputFramePt, 1, NULL );
			MediaProcThreadPt->m_PcmAudioInputFramePt = NULL;
		}
		if( MediaProcThreadPt->m_PcmAudioOutputFramePt != NULL ) //如果取出了PCM格式音频输出帧，就追加到音频输出空闲帧链表。注意：从取出到追加过程中不能跳出，否则会内存泄露。
		{
			MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.PutTail( &MediaProcThreadPt->m_PcmAudioOutputFramePt, 1, NULL );
			MediaProcThreadPt->m_PcmAudioOutputFramePt = NULL;
		}
		if( MediaProcThreadPt->m_VideoInputFramePt != NULL ) //如果取出了视频输入帧，就追加到视频输入空闲帧链表。注意：从取出到追加过程中不能跳出，否则会内存泄露。
		{
			MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.PutTail( &MediaProcThreadPt->m_VideoInputFramePt, 1, NULL );
			MediaProcThreadPt->m_VideoInputFramePt = NULL;
		}
	...
	//销毁音频输入。
    {
		...
		//销毁音频输入帧链表、音频输入空闲帧链表。
		{
			if( MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.m_ConstLenLnkLstPt != NULL )
			{
				while( MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.GetHead( NULL, &MediaProcThreadPt->m_PcmAudioInputFramePt, NULL, 0, NULL ) == 0 )
				{
					free( MediaProcThreadPt->m_PcmAudioInputFramePt );
					MediaProcThreadPt->m_PcmAudioInputFramePt = NULL;
					MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.DelHead( 0, NULL );
				}
				if( MediaProcThreadPt->m_AudioInput.m_AudioInputFrameLnkLst.Destroy( MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
				{
			...
			if( MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.m_ConstLenLnkLstPt != NULL )
			{
				while( MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.GetHead( NULL, &MediaProcThreadPt->m_PcmAudioInputFramePt, NULL, 0, NULL ) == 0 )
				{
					free( MediaProcThreadPt->m_PcmAudioInputFramePt );
					MediaProcThreadPt->m_PcmAudioInputFramePt = NULL;
					MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.DelHead( 0, NULL );
				}
				if( MediaProcThreadPt->m_AudioInput.m_AudioInputIdleFrameLnkLst.Destroy( MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
				{
	...
	//销毁音频输出。
	{
		...
		//销毁音频输出帧链表、音频输出空闲帧链表。
		{
			if( MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.m_ConstLenLnkLstPt != NULL )
			{
				while( MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.GetHead( NULL, &MediaProcThreadPt->m_PcmAudioOutputFramePt, NULL, 0, NULL ) == 0 )
				{
					free( MediaProcThreadPt->m_PcmAudioOutputFramePt );
					MediaProcThreadPt->m_PcmAudioOutputFramePt = NULL;
					MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.DelHead( 0, NULL );
				}
				if( MediaProcThreadPt->m_AudioOutput.m_AudioOutputFrameLnkLst.Destroy( MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
				{
			...
			if( MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.m_ConstLenLnkLstPt != NULL )
			{
				while( MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.GetHead( NULL, &MediaProcThreadPt->m_PcmAudioOutputFramePt, NULL, 0, NULL ) == 0 )
				{
					free( MediaProcThreadPt->m_PcmAudioOutputFramePt );
					MediaProcThreadPt->m_PcmAudioOutputFramePt = NULL;
					MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.DelHead( 0, NULL );
				}
				if( MediaProcThreadPt->m_AudioOutput.m_AudioOutputIdleFrameLnkLst.Destroy( MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
				{
	...
	//销毁视频输入。
	{
		...
		//销毁视频输入帧链表、视频输入空闲帧链表。
		{
			if( MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLst.m_ConstLenLnkLstPt != NULL )
			{
				while( MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLst.GetHead( NULL, &MediaProcThreadPt->m_VideoInputFramePt, NULL, 0, NULL ) == 0 )
				{
					free( MediaProcThreadPt->m_VideoInputFramePt->m_YU12VideoInputFramePt );
					MediaProcThreadPt->m_VideoInputFramePt->m_YU12VideoInputFramePt = NULL;
					if( MediaProcThreadPt->m_VideoInputFramePt->m_EncoderVideoInputFramePt != NULL )
				...
				if( MediaProcThreadPt->m_VideoInput.m_VideoInputFrameLnkLst.Destroy( MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
				{
			...
			if( MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.m_ConstLenLnkLstPt != NULL )
			{
				while( MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.GetHead( NULL, &MediaProcThreadPt->m_VideoInputFramePt, NULL, 0, NULL ) == 0 )
				{
					free( MediaProcThreadPt->m_VideoInputFramePt->m_YU12VideoInputFramePt );
					MediaProcThreadPt->m_VideoInputFramePt->m_YU12VideoInputFramePt = NULL;
					if( MediaProcThreadPt->m_VideoInputFramePt->m_EncoderVideoInputFramePt != NULL )
					...
					free( MediaProcThreadPt->m_VideoInputFramePt );
					MediaProcThreadPt->m_VideoInputFramePt = NULL;
					MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.DelHead( 0, NULL );
				}
				if( MediaProcThreadPt->m_VideoInput.m_VideoInputIdleFrameLnkLst.Destroy( MediaProcThreadPt->m_ErrInfoVarStrPt ) == 0 )
				{
